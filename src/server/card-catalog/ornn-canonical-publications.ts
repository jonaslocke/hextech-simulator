...
const models: Record<string, Clause[]> = {
  ...
  "OGN-045": [[["timing", "timing.reaction", {}], ["selector", "selector.chain_item", { itemKind: "spell", maximumEnergyCost: 4, maximumPowerCost: 1, minimumCount: 1, maximumCount: 1, selectionKey: "spell" }], ["action", "action.counter_chain_item", { selectionKey: "spell" }]]],
  ...
  "SFD-213": [[["modifier", "modifier.modify_numeric_value", { attribute: "energyCost", operation: "reduce", operand: "constant", amount: 1, minimum: 0, target: "controller_card", cardType: "Gear", excludeTokens: true, duration: "whileSourceAtBattlefield", condition: "firstCardOfTypePlayedThisTurn", conditions: "sourceControllerControlsBattlefield" }]]],
