...
const DECK_ID = "annie-harrowing" as const;
const DECK_LABEL = "Annie - Harrowing";
const DECK_FILE_PATH = "data/decks/annie-harrowing.txt";
...
try {
  ...
  const result = await syncAnnieHarrowingDeck(db, sourceText);
  console.log(
...
async function syncAnnieHarrowingDeck(
  db: Db,
  sourceText: string,
