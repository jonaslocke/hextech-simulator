...
if (!process.argv.includes("--confirm")) {
  throw new Error("Refusing to approve the OGN effect-driven play family without --confirm.");
}
...
const MODELS: Record<string, Assignment[]> = {
  "OGN-165": [
    ...
    { family: "selector", primitiveId: "selector.card", parameters: { zone: "trash", cardType: "Unit", owner: "controller", minimumCount: 1, maximumCount: 1, selectionKey: "unitToReturn" } },
  ...
  "OGN-196": [
    { family: "trigger", primitiveId: "trigger.on_play", parameters: { actor: "controller", subject: "source" } },
    { family: "selector", primitiveId: "selector.card", parameters: { zone: "trash", cardType: "Unit", owner: "controller", minimumCount: 0, maximumCount: 1, requiresPayablePowerCost: true, selectionKey: "unitToPlay" } },
    { family: "action", primitiveId: "action.play_selected_unit", parameters: { sourceSelectionKey: "unitToPlay", selectionKey: "destination", costMode: "powerOnly" } },
  ],
  "OGN-198": [
    { family: "selector", primitiveId: "selector.card", parameters: { zone: "trash", cardType: "Unit", owner: "controller", minimumCount: 1, maximumCount: 1, requiresPayablePowerCost: true, selectionKey: "unitToPlay" } },
    { family: "action", primitiveId: "action.play_selected_unit", parameters: { sourceSelectionKey: "unitToPlay", selectionKey: "destination", costMode: "powerOnly" } },
  ],
};
...
try {
  ...
  for (const [cardCode, assignments] of Object.entries(MODELS)) {
    ...
    const document = await publishCanonicalCard(
      db,
      {
        adminNotes: "OGN M2 effect-driven Unit recovery and play-from-Trash family.",
        card,
