...
function fixture(): { game: GameDocument; decks: DeckSnapshotDocument[] } {
  ...
  const game: GameDocument = {
    ...
    state: {
      ...
      cardStates: states, turn: { turnNumber: 1, activePlayerId: "p1", phase: "action" }, chain: null, showdown: null, combat: null, modifiers: [], ongoingEffects: [], delayedEffects: [], effectResolutions: [], pendingChoice: null, queuedTriggerChoices: []
    }
  };
  return { game, decks };
}
